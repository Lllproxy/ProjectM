...
public class CodeGenerator {
    ...
    private static final String PACKAGE_PATH_SERVICE = packageConvertPath(MYSQL_SERVICE_PACKAGE);//生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath(MYSQL_SERVICE_IMPL_PACKAGE);//生成的Service实现存放路径
    private static final String PACKAGE_PATH_CONTROLLER = packageConvertPath(CONTROLLER_PACKAGE);//生成的Controller存放路径

    private static final String AUTHOR = "bocheng.luo";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date
    
    private static final String MODEL_PACKAGE = MYSQL_MODEL_PACKAGE;
    private static final String MAPPER_PACKAGE = MYSQL_MAPPER_PACKAGE;
    
    public static void main(String[] args) {
    	  genCode(new String[]{"share_value_base"});
//    	  genCode(new String[]{"user_info","power","role",
//                  "verify_log","web_info","server_info",
//                  "power_web","power_server","powe_type",
//                  "usergroup_user","usergroup_role","role_power",
//                  "usergroup","user_role","user_power"});
//    	  genCode(new String[]{"T_ABNORMAL_CROSS_INFO","T_ABNORMAL_ROADSEG_INFO"});
//    	  genCode(new String[]{"T_BASE_CROSSDIR_INFO","T_BASE_CROSSDIR_LINKS","T_BASE_CROSS_INFO"});
    ...
    public static void genModelAndMapper(String tableName) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage("mapper/mysql");
